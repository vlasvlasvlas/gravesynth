...
import { initAudio, createPortalAudio, updatePortalAudio, removePortalAudio, handleImpact, handleAbsorptionFade, updateBpm, setMasterVolume, setPaused } from './audio.js';
